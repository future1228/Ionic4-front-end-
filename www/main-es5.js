...
/* harmony import */ var _services_authentication_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/authentication/guards/auth.guard */ "./src/app/services/authentication/guards/auth.guard.ts");




var routes = [
    { path: '', loadChildren: function () { return __webpack_require__.e(/*! import() | public-login-login-module */ "public-login-login-module").then(__webpack_require__.bind(null, /*! ./public/login/login.module */ "./src/app/public/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); } },
    //{ path: 'home', loadChildren: () => import('./home/home.module').then( m => m.HomePageModule)},
    {
        path: 'login',
        loadChildren: function () { return __webpack_require__.e(/*! import() | public-login-login-module */ "public-login-login-module").then(__webpack_require__.bind(null, /*! ./public/login/login.module */ "./src/app/public/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); }
    },
    {
        path: 'register',
        loadChildren: function () { return __webpack_require__.e(/*! import() | public-register-register-module */ "public-register-register-module").then(__webpack_require__.bind(null, /*! ./public/register/register.module */ "./src/app/public/register/register.module.ts")).then(function (m) { return m.RegisterPageModule; }); }
    },
    {
        path: 'menu',
        canActivate: [_services_authentication_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-menu-menu-module */ "pages-menu-menu-module").then(__webpack_require__.bind(null, /*! ./pages/menu/menu.module */ "./src/app/pages/menu/menu.module.ts")).then(function (m) { return m.MenuPageModule; }); }
    }
];
...
var USER_DATA = 'auth-token';
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storage, platform, loadingCtrl, http, toastController) {
        var _this = this;
        ...
        this.BACKEND_DOMAIN = 'http://stackooh.com/Stackooh_backend/index.php';
        // BACKEND_DOMAIN: any = 'http://localhost/v1/index.php';
        this.APIURL = this.BACKEND_DOMAIN + '/login';
        this.authenticationState = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](false);
        this.verifyState = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](false);
        this.activeState = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](false);
        this.platform.ready().then(function () {
            _this.checkToken();
        });
        //this.checkVerified();
    ...
    AuthenticationService.prototype.checkToken = function () {
        var _this = this;
        this.storage.get(USER_DATA).then(function (res) {
            if (res) {
    ...
    //   });
    // }
    AuthenticationService.prototype.register = function (request) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (request.password !== request.confirm) {
                            ...
                            return [2 /*return*/, this.http.post(this.APIURL + '/register', request).subscribe(function (data) {
                                    _this.storage.set(USER_DATA, JSON.stringify(data)).then(function (res) {
                                        _this.authenticationState.next(true);
                                        _this.checkToken();
                                        loading.dismiss();
                                    });
                                }, function (error) {
                                    var tMessage = error.error['message'];
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        loading = _a.sent();
                        loading.present();
                        return [2 /*return*/, this.http.post(this.APIURL + '/Check', request).subscribe(function (data) {
                                if (data == 1) {
                                    _this.storage.set(USER_DATA, JSON.stringify(data)).then(function (res) {
                                        _this.authenticationState.next(true);
                                        loading.dismiss();
                                ...
                                var tMessage = error.error['error'];
                                if (error.error['error'] == "undefined") {
    ...
    AuthenticationService.prototype.logout = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.storage.remove(USER_DATA).then(function (res) {
...
/***/ "./src/app/services/authentication/guards/auth.guard.ts":
/*!**************************************************************!*\
  !*** ./src/app/services/authentication/guards/auth.guard.ts ***!
  \**************************************************************/
...
module.exports = __webpack_require__(/*! D:\work\upwork work history\Arshak\Ionic\New folder\frontend\src\main.ts */"./src/main.ts");
